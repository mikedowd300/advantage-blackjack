...
import { deviationFinder } from '../../doubleup-blackjack/default-doubleup-configs/play-strategies/deviation-finder';

@Injectable({
  providedIn: 'root'
})
export class DuPlayChartDataStorageService {
  playStrategy: any = null;
  deviationF2cData: any = null;
  allDeviationData: any;
  variation: LocalStorageVariationKeys = LocalStorageVariationKeys.DOUBLE_UP;
