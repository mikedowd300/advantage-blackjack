import { TippingPlan } from "../doubleup-models/doubleup-strategies.models";
...
export const doubleupTippingTitles: string[] = [
  "Cheap Tipper", 
  "Generous Tipper", 
  "Never Tips"
];

export const doubleupTippingPlans: { [k: string]: TippingPlan } = {
  "Cheap Tipper": cheapTipper, 
  "Generous Tipper": generousTipper, 
  "Never Tips": neverTips,
}

export const doubleupDefaultTippingPlan = neverTips;