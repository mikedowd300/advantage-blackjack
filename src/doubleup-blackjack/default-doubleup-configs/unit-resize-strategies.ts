...
export const resizeReduceRisk: UnitResizeStrategy = {
  ...
  increaseAtMultiple: [
    30000, 70000, 110000, 150000, 200000, 250000, 300000, 350000, 40000
  ],
  decreaseAtMultiple: [
...
export const doubleupUnitResizingStrategyTitles: string[] = [
  'Resize Reduce Risk',
  'High Risk to Low Risk',
  'Never Resize',
];

export const doubleupUnitResizingStrategies: {  [k: string]: UnitResizeStrategy } = {
  'Resize Reduce Risk': resizeReduceRisk, 
  'High Risk to Low Risk': hiRiskToLoRisk,
  'Never Resize': neverResize,
};

export const doubleupDefaultUnitResizeStrategy = resizeReduceRisk;