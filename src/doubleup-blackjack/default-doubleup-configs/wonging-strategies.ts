import { WongStrategy } from "../doubleup-models/doubleup-strategies.models";
...
export const doubleupWongingTitles: string[] = [
  '1 More Spot', 
  '2 More Spots', 
  '3 More Spots',
  '2 More Quick',
...
export const doubleupWongs: { [k: string]: WongStrategy } = {
...
export const doubleupDefaultWong = neverWong;