import { BetSpreadStrategy } from '../doubleup-models/doubleup-strategies.models';
...
export const doubleupBetSpreadTitles: string[] = [
  "Basic 1 to 6", 
  "Basic 1 to 6 Wong",
  "Quick 1 to 8",
  "Quick 1 to 10",
...
export const doubleupBetSpreads: { [k: string]: BetSpreadStrategy } = {
...
export const defaultDoubleupBetSpread: BetSpreadStrategy = basic1to6;