...
import { UnitResizeStrategy } from '../../../../doubleup-blackjack/doubleup-models/doubleup-strategies.models';
import { LocalStorageItemsEnum, LocalStorageVariationKeys } from '../../../../models';
import {
  doubleupUnitResizingStrategyTitles,
  doubleupUnitResizingStrategies,
  doubleupDefaultUnitResizeStrategy
} from "../../../../doubleup-blackjack/default-doubleup-configs/unit-resize-strategies";
import { BehaviorSubject } from 'rxjs';
import { TooltipService } from '../../../../services/tooltip.service';
import { HeaderFooterService } from '../../../../services/header-footer.service';

@Component({
  selector: 'doubleup-customizations-unit-resizing',
  standalone: true,
  imports: [
  ...
  templateUrl: './doubleup-customizations-unit-resizing.component.html',
  styleUrl: './doubleup-customizations-unit-resizing.component.scss'
})
export class DoubleupCustomizationsUnitResizingComponent implements OnInit {
  title: string = "Add, Edit or Delete a Unit Resizing strategy";
  defaultStrategy: UnitResizeStrategy = { ...doubleupDefaultUnitResizeStrategy };
  activeStrategy: UnitResizeStrategy = { ...doubleupDefaultUnitResizeStrategy };
  activeStrategy$: BehaviorSubject<UnitResizeStrategy> = new BehaviorSubject<UnitResizeStrategy>(doubleupDefaultUnitResizeStrategy);
  localStorageItemsEnum = LocalStorageItemsEnum;
  localStorageVariationKeys = LocalStorageVariationKeys;
  defaultSpreads = doubleupUnitResizingStrategies;
  allStrategies: { [k: string]: UnitResizeStrategy};
  allStrategyTitles: string[];
  defaultStrategyTitles: string[] = doubleupUnitResizingStrategyTitles;
  toolTipBody: string[];
  toolTipIds: string[];
