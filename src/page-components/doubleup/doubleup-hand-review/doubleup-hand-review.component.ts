...
import {
  PlayerRecord,
  TableRecord
} from '../../../doubleup-blackjack/doubleup-engine/du-record-store/record-models';

@Component({
  selector: 'doubleup-hand-review',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './doubleup-hand-review.component.html',
  styleUrl: './doubleup-hand-review.component.scss'
})
export class DoubleupHandReviewComponent implements AfterViewInit, OnInit {
  ...
  constructor(public gameData: DuGameEngineData) {}
