...
@Component({
  selector: 'doubleup-bankroll-chart',
  standalone: true,
  imports: [FormsModule, CommonModule, RouterLink],
  templateUrl: './doubleup-bankroll-chart.component.html',
  styleUrl: './doubleup-bankroll-chart.component.scss'
})

export class DoubleupBankrollChartComponent implements OnDestroy, OnInit {
  handles: string[];
  chart: Chart;
